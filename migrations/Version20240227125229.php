 ...
 */
final class Version20240227125229 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE employer_rdv (employer_id INT NOT NULL, rdv_id INT NOT NULL, INDEX IDX_CB8622A941CD9E7A (employer_id), INDEX IDX_CB8622A94CCE3F86 (rdv_id), PRIMARY KEY(employer_id, rdv_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
